...
public class Function {
    ...
    public String[] locate() {
        ...
        // new array from vec[0], vec[1], vec[2], vec[vec.size() - 1]
        String randomValue = String.valueOf(random.nextInt(1003 / 5) + 1);
        String arr[] = new String[] {vec.get(0), vec.get(1), vec.get(2), vec.get(vec.size() - 1),
                randomValue};
